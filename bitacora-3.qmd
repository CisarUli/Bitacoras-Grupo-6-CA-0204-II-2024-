...
Para esta bitácora se añade un nuevo método: el modelo autorregresivo integrado de media móvil (ARIMA), además de nuevas fichas bibliográficas respceto al nuevo método.
...
Al analizar el patrón de sobrevivientes se pueden proyectar el número futuro de 
sobrevivientes migrantes en un horizonte de 5 años.

**- Predicción puntual:** Se puede observar que es más probable que sobrevivan o
sean rescatados 8.011 migrantes por año.
