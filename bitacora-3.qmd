...
elementos <- data.frame(
  ...
  Temas = c(
    "1. Geografía de la migración<br>
    2. Importancia de los datos migratorios para modelar y formar correctas políticas<br>
    3. Aspectos psicológicos de la inmigración<br>
    4. Protección de migrantes de desapariciones forzadas",
    
    "1. Las medidas de tendencia central<br>
    2. Análisis de regresión lineal simple<br>
    3. Cómo utilizar el modelo ARIMA",
    
    "1. Predicción de muertes de migrantes<br>
    2. Predicción de sobrevivientes migrantes<br>
    3. Predicción de desapariciones de migrantes<br>
    4. Comparación de muertes y rescates de migrantes<br>
    5. Implicaciones de la desaparición de inmigrantes"
    )
)
kable(elementos, "html", escape = FALSE, col.names = c("Sección", "Temas a tratar")) |>
  kable_styling("striped", full_width = F) |>
  add_header_above(c("Elementos de reporte" = 2)) |>
